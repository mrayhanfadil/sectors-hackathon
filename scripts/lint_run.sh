...
echo "[1/4] Running ruff check --fix..."
...
echo "[3/4] Running pytest agents/valuation/ scripts/test_audit_quintet.py..."
...
echo "[4/4] Running post-agy recovery harness..."
