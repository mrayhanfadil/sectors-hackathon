...
def main() -> None:
    ...
    # implements the house format (docs/rules/house-report-format.md). The shared
    # furniture lives in server/report/house_format.py and is covered by
    # tests/test_house_format_adoption.py.
