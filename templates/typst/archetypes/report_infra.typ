...
#page-wrap(m.at("prepared_by", default: "RESEARCH — Equity Report"), m.date, m.ticker, 8, PALETTE, [
  ...
  #exhibit-header("Laporan Laba Rugi Komprehensif 6 Tahun", fin_is.source)
  #v(2pt)
  #fin-table(
  ...
  #v(6pt)
  #exhibit-header("Neraca Keuangan Konsolidasian 6 Tahun (FY24A - FY29F)", fin_bs.source)
  #v(2pt)
  #fin-table(
...
#page-wrap(m.at("prepared_by", default: "RESEARCH — Equity Report"), m.date, m.ticker, 9, PALETTE, [
  ...
  #grid(
    ...
    column-gutter: 8pt,
    [
      #exhibit-header("Laporan Arus Kas 6Y (FY24A - FY29F)", fin_cf.source)
      #v(1pt)
      #compact-fin-table(
    ...
    [
      #exhibit-header("Rasio Keuangan 6 Tahun vs Peer Median", fin_ratio.source)
      #v(1pt)
      #compact-fin-table(
