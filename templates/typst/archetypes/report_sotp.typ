...
#page-wrap(
  ...
  [
    ...
    #v(5pt)
    #exhibit-header("Laporan Laba Rugi & Kinerja Keuangan Konsolidasian 6 Tahun", "Laporan Keuangan CDIA & Proyeksi Riset")
    #v(1pt)
    #fin-table(
    ...
    #v(6pt)
    #exhibit-header("Rasio Neraca, Likuiditas & Profitabilitas 6Y vs Peer Median", "Kalkulasi Riset & Data Olahan")
    #v(1pt)
    #fin-table(
