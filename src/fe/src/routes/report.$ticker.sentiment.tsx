  ...
  if (sentimentQuery.isError && !sentimentData) {
    return (
      <div className="space-y-6">
        ...
        />
        <div className="rounded-xl border border-rose-200 bg-rose-50/70 p-6 text-neutral-800 shadow-2xs">
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="rounded-md border border-neutral-200 border-l-2 border-l-[#0070f3] bg-white p-3 text-xs leading-relaxed text-neutral-600">
        <span className="font-semibold text-[#0a0a0a]">Baru mulai baca sentimen saham? </span>
