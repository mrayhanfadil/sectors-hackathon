...
function MockSectorsRedirect() {
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <Card className="border-slate-200 bg-white p-2 shadow-sm dark:border-slate-800 dark:bg-[#111111]">
        <CardHeader>
        ...
        <CardContent className="flex flex-wrap gap-2">
          <a href="/report/BBCA" className={`${btn} bg-slate-900 text-white hover:bg-slate-700 dark:bg-slate-800`}>
          ...
          <a
            href="/"
            className={`${btn} border border-slate-200 bg-white text-slate-700 hover:bg-slate-50 dark:border-slate-800 dark:bg-[#111111] dark:text-slate-300 dark:hover:bg-slate-900`}
          >
