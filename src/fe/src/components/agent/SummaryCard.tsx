...
export const SummaryCard = memo(function SummaryCard({
  ...
  return (
    <Card className={cn("overflow-hidden border-emerald-200 bg-linear-to-b from-emerald-50/50 to-white shadow-none", className)}>
      <CardContent className="p-5 sm:p-6 space-y-4">
        {/* Header Title + Recommendation */}
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border-b border-emerald-100/80 pb-4">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <Badge variant="outline" className="bg-white font-mono text-xs font-semibold uppercase text-neutral-800 border-neutral-300">
                {t}
              </Badge>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <Link
              to="/report/$ticker"
              params={{ ticker: t }}
              className="inline-flex items-center gap-1.5 rounded-lg bg-neutral-900 px-3 py-2 text-xs font-medium text-white shadow-none transition-colors hover:bg-neutral-800"
            >
        ...
        <div className="space-y-2">
          ...
          <div className="grid gap-2 sm:grid-cols-3">
            <div className="flex items-start gap-2.5 rounded-lg border border-neutral-200/80 bg-white p-3 shadow-2xs">
              <Database className="mt-0.5 h-4 w-4 shrink-0 text-sky-600" />
              <div className="text-xs leading-relaxed text-neutral-700">
                <span className="font-semibold text-neutral-900">Data Terintegrasi: </span>
            ...
            <div className="flex items-start gap-2.5 rounded-lg border border-neutral-200/80 bg-white p-3 shadow-2xs">
              ...
              <div className="text-xs leading-relaxed text-neutral-700">
                <span className="font-semibold text-neutral-900">Valuasi Deterministik: </span>
            ...
            <div className="flex items-start gap-2.5 rounded-lg border border-neutral-200/80 bg-white p-3 shadow-2xs">
              ...
              <div className="text-xs leading-relaxed text-neutral-700">
                <span className="font-semibold text-neutral-900">Uji Kritis Red Team: </span>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-neutral-200/60 text-xs text-neutral-500">
          ...
          <div className="flex items-center gap-1 text-[11px] text-neutral-500 italic">
