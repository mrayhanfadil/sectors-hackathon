...
const FUNCTION_TRANSLATIONS: Record<string, string> = {
  ...
  google_search: "Mencari informasi dan berita terbaru dari internet",
  web_search: "Mencari informasi dan berita terbaru dari internet",
  web_search_and_extract: "Mencari dan mengekstrak artikel berita terkait",
  web_extract: "Mengekstrak data dari halaman web sumber",
