...
export const AGENT_FRIENDLY_MAP: Record<string, AgentFriendlyMeta> = {
  ...
  analyst: {
    ...
    stageIndex: 3,
    icon: TrendingUp,
    badgeBg: "bg-[#F5F2EB] dark:bg-[#23211C]",
    badgeText: "text-[#1C1B17] dark:text-[#EDEAE3]",
    badgeBorder: "border-[#E7E3DA] dark:border-[#2A2822]",
  ...
  critic: {
    ...
    stageIndex: 5,
    icon: ShieldCheck,
    badgeBg: "bg-[#0E6E63]/10 dark:bg-[#4FD1B5]/15",
    badgeText: "text-[#0E6E63] dark:text-[#4FD1B5]",
    badgeBorder: "border-[#0E6E63]/25 dark:border-[#4FD1B5]/30",
    dotColor: "bg-[#0E6E63]",
  ...
  system: {
    ...
    icon: Cpu,
    badgeBg: "bg-[#F5F2EB] dark:bg-[#23211C]",
    badgeText: "text-[#6B6659] dark:text-[#A8A296]",
    badgeBorder: "border-[#E7E3DA] dark:border-[#2A2822]",
    dotColor: "bg-[#6B6659]",
