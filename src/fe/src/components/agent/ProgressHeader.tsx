...
export const ProgressHeader = memo(function ProgressHeader({
  ...
  return (
    <div className="rounded-md border border-neutral-200 bg-white p-5 shadow-none space-y-4">
      {/* Top Header Row */}
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="space-y-1.5 max-w-3xl">
          <div className="flex items-center gap-2">
            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-neutral-900 text-white shadow-none">
          ...
          <p className="text-sm leading-relaxed text-neutral-600">
            11 agents → <span className="font-medium text-neutral-800">Muse Spark 1M</span> via CommandCode bridge{" "}
            <code className="rounded bg-neutral-100 px-1 py-0.5 font-mono text-xs text-neutral-700">127.0.0.1:9992</code> · intake_parallel → modeler → research_parallel → writer → visualizer → sotp → adversarial×4 → critic. Stream SSE{" "}
            <code className="rounded bg-neutral-100 px-1 py-0.5 font-mono text-xs text-neutral-700">/api/agent/stream</code> for step-by-step.
          </p>
          ...
          {health && (
            <div className="flex flex-wrap items-center gap-2 pt-1 text-xs">
              ...
              <Badge variant="outline" className="font-mono text-[11px] text-neutral-600">
              ...
              <Button
                size="sm"
                variant="outline"
                className="h-6 px-2 text-[11px] text-neutral-600 hover:text-neutral-900"
        ...
        <div className="flex flex-col items-end gap-1.5">
          <div className="flex items-center gap-2 rounded-lg border border-neutral-200 bg-neutral-50 px-3 py-1.5 text-xs shadow-2xs">
            {running ? (
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-neutral-400">·</span>
                <span className="font-mono text-neutral-700">{done.n_events} events</span>
                <span className="text-neutral-400">·</span>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-neutral-400">·</span>
                <span className="font-mono text-neutral-700">{events.length} events</span>
              </div>
            ) : (
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-neutral-400" />
                <span className="font-medium text-neutral-700">Ready</span>
                <span className="text-neutral-400">·</span>
                <span className="text-neutral-500">SSE + blocking</span>
              </div>
            )}
          </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <label className="flex items-center gap-2 text-xs font-medium text-neutral-700">
            ...
            <select
              ...
              className="h-8 rounded-md border border-neutral-300 bg-white px-2.5 text-sm font-mono font-semibold uppercase text-neutral-900 shadow-2xs focus:border-neutral-800 focus:outline-none focus:ring-1 focus:ring-neutral-800"
            >
          ...
          <Button
            ...
            disabled={running}
            className="h-8 gap-1.5 bg-neutral-900 text-xs font-medium text-white hover:bg-neutral-800"
          >
            {running ? (
              <>
          ...
          <Button
            ...
            disabled={running}
            variant="outline"
            className="h-8 text-xs font-medium text-neutral-700 border-neutral-300 hover:bg-neutral-50"
          >
            Run (blocking POST)
          </Button>
          ...
          <Button
            onClick={onClear}
            variant="ghost"
            className="h-8 gap-1 text-xs text-neutral-600 hover:bg-neutral-100 hover:text-neutral-900"
            disabled={running}
          >
