        ...
        <CardContent className="p-4 pt-2 space-y-3">
          ...
          <div className="rounded-lg border border-slate-100 bg-slate-50/80 p-3 space-y-2">
            <div className="flex items-center justify-between text-xs">
              <span className="text-slate-500">Harga Terkini</span>
              <span className="font-mono font-semibold text-slate-900">
                {price != null ? `Rp ${fmtIDR(price)}` : "-"}
              </span>
            </div>
            <div className="flex items-center justify-between text-xs">
              <span className="text-slate-500">Nilai Wajar (TP)</span>
          ...
          <div className="grid grid-cols-2 gap-2 border-t border-slate-100 pt-3">
            <Link
              ...
              params={{ ticker: tk }}
              className="inline-flex items-center justify-center gap-1 rounded-md border border-slate-200 bg-white px-2.5 py-1.5 text-xs font-medium text-slate-700 hover:bg-slate-50 hover:text-slate-900 transition-colors"
            >
        ...
        <CardContent className="p-4 pt-1">
          <nav className="space-y-1 text-xs">
            <a
              ...
              className="flex items-center justify-between rounded px-2 py-1.5 text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-colors"
            >
          ...
          {provenance && (
            <div className="mt-3 border-t border-slate-100 pt-2.5 text-[11px] text-slate-400 font-mono flex items-center gap-1">
