...
def _build_live_payload(ticker: str, template_override: Optional[str]) -> dict:
    ...
    try:
        ...
        # Deck slide 4: the intrinsic valuation page, arithmetic from the internal FCFF engine.
...
def render_html_for_ticker(
    ...
    html = tpl.render(**data, template_reason=reason, fonts_dir=fonts_dir, palette={"brand": "#0928B1", "brand_dark": "#0047AB", "accent": "#B4C7FF"})
