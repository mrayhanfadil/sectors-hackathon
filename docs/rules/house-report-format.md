...
renderers share), `server/report/house_rules.py` (the executable form of §7-§9),
`server/report/cover_slide1.py` + `server/report/slide2.py` (the cover builders),
